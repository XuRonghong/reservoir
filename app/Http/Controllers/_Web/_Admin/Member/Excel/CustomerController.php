...
class CustomerController extends _ExcelController
{
    const DATA_SYNCED = 'SYNCED';
    const DATA_NEW = 'NEW';
    const DATA_EDIT = 'EDIT';

    public $module = [ 'admin', 'member', 'excel', 'customer' ];
    protected $store_name = 'member_customer';
    protected $store_type = 'xlsx';
    ...
    public function importDataMap ( $row/*$row_arr*/ ): array
    {
        //變數Mapping
        ...
        return parent::importDataMap( $row/*$row_arr*/ );
    }
