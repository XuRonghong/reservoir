...
namespace App\Http\Controllers\_Web\Scenes\Login;
...
class BackgroundController extends _WebController
{
    public $module = ['scenes', 'login', 'background'];
    protected $iMenuId = 60101;
