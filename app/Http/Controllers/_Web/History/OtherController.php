...
class OtherController extends _WebController
{
    ...
    public function index ()
    {
        ...
        $this->view->with( 'vSummary', '水庫其他重要文件' );
    ...
    public function doAdd ( Request $request )
    {
        ...
        $Dao->iType = 3;    //1.水庫淤積濬渫執行成果  2. 水庫歷屆定期安全評估報告  3.水庫其他重要文件
