                ...
                <ul id="sidebarnav">
                    ...
                    {{--<li>--}}
                        ...
                        {{--<div class="user-profile d-flex no-block dropdown m-t-20">--}}
                            {{--<div class="user-pic"><img src="{{url('xtreme-admin/assets/images/users/1.jpg')}}" alt="users" class="rounded-circle" width="40" /></div>--}}
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-border-all"></i><span class="hide-menu">會員 Tables</span></a>
                        <ul aria-expanded="false" class="collapse first-level">
                            <li class="sidebar-item"><a href="{{url('member/')}}" class="sidebar-link"><i class="mdi mdi-border-nono"></i><span class="hide-menu">總表 </span></a></li>
                            <li class="sidebar-item"><a href="{{url('member/add')}}" class="sidebar-link"><i class="mdi mdi-border-nono"></i><span class="hide-menu">新增 </span></a></li>
                            <li class="sidebar-item"><a href="{{url('member/')}}" class="sidebar-link"><i class="mdi mdi-border-nono"></i><span class="hide-menu">修改 </span></a></li>
                            <li class="sidebar-item"><a href="{{url('member/')}}" class="sidebar-link"><i class="mdi mdi-border-nono"></i><span class="hide-menu">刪除</span></a></li>
                        </ul>
                    </li>
