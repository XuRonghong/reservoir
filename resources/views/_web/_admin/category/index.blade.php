                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="text" class="form-control vCategoryValue" placeholder="{{trans('web.admin.category.category_value')}}" required/>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="text" class="form-control vCategoryName" placeholder="{{trans('web.admin.category.category_name')}}" required/>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="edit-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" id="myModalLabel">{{trans('web.admin.category.edit')}}</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                ...
                "aoColumns": [
                    ...
                    },
                    {
                        ...
                        "mRender": function (data, type, row) {
                            ...
                            btn += '<button class="btn btn-xs btn-default btn-sub" title="管理子項目"><i class="fa fa-list" aria-hidden="true"></i></button>';
                            return btn;
                        }
                    },
                ],
